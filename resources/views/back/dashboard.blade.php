...
<div class="container">
				...
				<div class="card">
					<div class="card-header">
						<h2>
							Sales Statistics <small>Vestibulum purus quam scelerisque, mollis
								nonummy metus</small>
						</h2>
				...
				<div class="row">
					<div class="col-sm-6">
						...
						<div class="card">
							<div class="card-header">
								<h2>
									Recent Items <small>Phasellus condimentum ipsum id auctor
										imperdie</small>
								</h2>
								<ul class="actions">
									<li class="dropdown"><a href="#" data-toggle="dropdown"> <i
						...
						<div id="todo" class="card card-light">
							<div class="card-header ch-alt">
								<h2>
									Todo Lists <small>Add, edit and manage your Todo Lists</small>
								</h2>
							</div>

							<div class="card-body card-padding">
								<div class="t-add">
									<i class="ta-btn zmdi zmdi-plus"
										data-ma-action="todo-form-open"></i>
									...
									<div class="ta-block">
										...
										<div class="tab-actions">
											<a data-ma-action="todo-form-close" href="#" class="c-red"><i
												class="zmdi zmdi-close"></i></a> <a
												data-ma-action="todo-form-close" href="#" class="c-green"><i
								...
								<div class="list-group">
									<div class="list-group-item media">
										...
										<div class="media-body">
											<div class="checkbox checkbox-light">
												<label> <input type="checkbox"> <i class="input-helper"></i>
									...
									<div class="list-group-item media">
										...
										<div class="media-body">
											<div class="checkbox checkbox-light">
												<label> <input type="checkbox"> <i class="input-helper"></i>
													<span> In vel imperdiet leoorbi mollis leo sit amet quam
														fringilla varius mauris orci turpis </span>
												</label>
											</div>
										</div>
									</div>
									...
									<div class="list-group-item media">
										...
										<div class="media-body">
											<div class="checkbox checkbox-light">
												<label> <input type="checkbox"> <i class="input-helper"></i>
													<span> Curabitur egestas finibus sapien quis faucibusras
														bibendum ut justo at sagittis. In hac habitasse platea
														dictumst </span>
												</label>
											</div>
										</div>
									...
									<div class="list-group-item media">
										...
										<div class="media-body">
											<div class="checkbox checkbox-light">
												<label> <input type="checkbox"> <i class="input-helper"></i>
													<span> Suspendisse potenti. Cras dolor augue, tincidunt sit
														amet lorem id, blandit rutrum libero </span>
												</label>
											</div>
										</div>
									</div>
					...
					<div class="col-sm-6">
						...
						<div class="card" id="calendar-widget">
							<div class="card-header ch-alt bgm-teal">
								...
								<button class="bgm-lightgreen btn btn-default bg btn-float">
						...
						<div class="card">
							<div class="card-header ch-alt m-b-20">
								<h2>
									Recent Posts <small>Phasellus condimentum ipsum id auctor
										imperdie</small>
								</h2>
								<ul class="actions">
									<li><a href="#"> <i class="zmdi zmdi-refresh-alt"></i>
							...
							<div class="card-body">
								<div class="list-group">
									<a class="list-group-item media" href="#">
										<div class="pull-left">
											<img class="lgi-img" src="{{ asset('assets/img/profile-pics/1.jpg') }}" alt="">
										</div>
										<div class="media-body">
										...
										<div class="pull-left">
											<img class="lgi-img" src="{{ asset('assets/img/profile-pics/2.jpg') }}" alt="">
										</div>
										<div class="media-body">
										...
										<div class="pull-left">
											<img class="lgi-img" src="{{ asset('assets/img/profile-pics/3.jpg') }}" alt="">
										</div>
										<div class="media-body">
										...
										<div class="pull-left">
											<img class="lgi-img" src="{{ asset('assets/img/profile-pics/4.jpg') }}" alt="">
										</div>
										<div class="media-body">
									...
									</a> <a class="view-more" href="#">View All</a>
								</div>
							</div>
						</div>
					</div>
