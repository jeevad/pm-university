				...
				<div class="list-group">
					<a class="list-group-item media" href="#">
						<div class="pull-left p-relative">
							<img class="lgi-img"
								src="{{ asset('assets/img/profile-pics/2.jpg') }}" alt=""> <i
								class="chat-status-busy"></i>
						</div>
						...
						<div class="pull-left p-relative">
							<img class="lgi-img"
								src="{{ asset('assets/img/profile-pics/3.jpg') }}" alt=""> <i
								class="chat-status-online"></i>
						</div>
						<div class="media-body">
						...
						<div class="pull-left p-relative">
							<img class="lgi-img"
								src="{{ asset('assets/img/profile-pics/4.jpg') }}" alt=""> <i
								class="chat-status-online"></i>
						</div>
						<div class="media-body">
						...
						<div class="pull-left">
							<img class="lgi-img"
								src="{{ asset('assets/img/profile-pics/5.jpg') }}" alt="">
						</div>
						<div class="media-body">
						...
						<div class="pull-left">
							<img class="lgi-img"
								src="{{ asset('assets/img/profile-pics/6.jpg') }}" alt="">
						</div>
						<div class="media-body">
