...
class PaginationPresenter implements PresenterContract
{
    ...
    {
        if ($this->hasPages()) {
            return new HtmlString(sprintf('<ul class="pagination">%s %s %s %s %s</ul>', $this->getFirst(), $this->getPreviousButton('&lsaquo;'), $this->getLinks(), $this->getNextButton('&rsaquo;'), $this->getLast()));
        }
