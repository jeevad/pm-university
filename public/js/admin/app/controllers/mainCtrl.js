 ...
 */
app.controller('AppCtrl', ['$rootScope', '$scope', '$state', '$window', '$document', '$timeout', 'cfpLoadingBar', 'Data',
    function ($rootScope, $scope, $state, $window, $document, $timeout, cfpLoadingBar, Data) {
        // Mobile headder
